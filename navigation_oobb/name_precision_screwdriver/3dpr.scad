...
difference() {
	union() {
		cylinder(h = 3, r1 = 1.2500000000, r2 = 5.5000000000);
		translate(v = [0, 0, 3]) {
		...
		translate(v = [0, 0, 51.0000000000]) {
			cylinder(h = 45, r1 = 5.5000000000, r2 = 6.5000000000);
		}
		translate(v = [0, 0, 98.5000000000]) {
			cylinder(h = 6.5000000000, r = 8.2500000000);
		}
		translate(v = [0, 0, 98.5000000000]) {
			cylinder(h = 5.7500000000, r = 9.0000000000);
		}
		translate(v = [0, 0, 104.2500000000]) {
	...
	union() {
		...
		translate(v = [4.0000000000, 0, 60]) {
			rotate(a = [0, 90, 350.0000000000]) {
				difference() {
					union() {
		...
		rotate(a = [0, 0, 0.0000000000]) {
			translate(v = [9.7000000000, 0, 0]) {
				translate(v = [-0.5000000000, -0.5000000000, 96.0000000000]) {
					rotate(a = [0, 0, 45]) {
						cube(size = [1, 1, 9]);
					}
				}
		...
		translate(v = [-1.7500000000, -3.7500000000, 50]) {
